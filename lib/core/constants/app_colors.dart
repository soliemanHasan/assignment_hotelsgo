...
class AppColors {
  ...
  static const Color darkGreen = Color(0xFF065e07);
  ...
  static const Color slider = Color(0xFF0073A5);
  static const Color index1 = Color(0XFFDB3734);
  static const Color index2 = Color(0XFFFC9E15);
  static const Color index3 = Color(0XFF62A30F);
  static const Color index4 = Color(0XFF028000);
  static const Color index5 = Color(0XFF005F00);
  static const Color containerStarColor = Color(0XFFF5A737);
